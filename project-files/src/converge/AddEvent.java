...
public class AddEvent{
	...
	*/
	...
	public int twelveHourtoInt(String time)//this method will take a String in 12 hour and return its corresponding int. 
	{
		...
		{
			timeAsInt = 50; //sets TimeAsInt to 50 for all other cases s it can throw an error if the time isn't one of the above.
		}
		return timeAsInt;
	}
	...
	public int twentyFourHourtoInt(String time)//this method will take a String in 24 hour and return its corresponding int. 
	{
		...
		{
			timeAsInt = 50; //sets timeAsInt to 50 so that it can throw an error if the time isn't one of the allowed ones above.
		}
		return timeAsInt;
	}
